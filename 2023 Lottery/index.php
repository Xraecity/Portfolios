        ...
        <div class="row">
            <?php
                ...
                try {
                    ...
                    if($count > 0){
                    echo '<label for="" class="col-12 alert alert-success alert-lg" id="success_label">' . $count . ' out of 10 list added successfully</label>';
                echo '
                            <b><a href="#toList">View Added list</a></b>' ;   
                }
                    else{
            ...
            $count_query = $pdo->query("SELECT COUNT(*) FROM lottery_entries");
            $count = $count_query->fetchColumn();
             if($count == 0)echo '12'; else echo '6'; ?>">
